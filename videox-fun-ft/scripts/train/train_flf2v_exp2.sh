export MODEL_NAME="/mnt/data/public_ckpt_1279/Wan-AI/Wan2.1-FLF2V-14B-720P/"
export DATASET_NAME="datasets/young2old_20250708"
export DATASET_META_NAME="datasets/young2old_20250708/json_of_flf_dataset_v2.json"
...
accelerate launch --use_deepspeed --deepspeed_config_file config/zero_stage2_config.json --deepspeed_multinode_launcher standard train_flf2v_lora.py \
  ...
  --seed=42 \
  --save_state \
  --output_dir="/mnt/workspace/log/flf2v/flf2v_young2old_exp2" \
